...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.26]{SnakeForward.png}
    \caption{Snake movement}
    %\label{fig:abc}
\end{figure}

The two snakes competing against each other perform their movements simultaneously. 
...
starting points of the snakes, and the number of rounds, can be adjusted in the methods of the SnakesUIMain class.
 \begin{figure}[h]
    \centering
    \includegraphics[scale=0.26]{SnakeApple.png}
    \caption{Snake Apple}
    %\label{fig:abc}
\end{figure}
